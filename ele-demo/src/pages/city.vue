<template>
    <div class="city_container">
        ...
        <form action="" v-on:submit.prevent class="city_form">
            <div>
                <input type="search" name="city" placeholder="输入学校, 商务楼, 地址" required v-model="inputValue" class="city_input input_style">
            </div>
            <div>
        ...
        <div class="search_none_place" v-if="!placelist.length">搜索无结果!</div>
    </div>
</template>
